...
// WhatsApp — read from brand config (update config/brand.json to change number)
const rawWA = (brand.contact?.whatsapp || '').replace(/\D/g, '')
const WHATSAPP_MSG = encodeURIComponent('Hola, tengo una pregunta sobre English for Work 👋')
...
export default function AppLayout() {
  ...
  return (
    <div className="app-layout">
      ...
      <header className="app-topbar">
        <div className="app-topbar-inner">
          ...
          <div className="app-topbar-right">
            {isAdmin && (
              <button className="btn btn-ghost btn-sm" onClick={() => navigate('/admin')} title="Panel Admin">
                ⚙️
              </button>
            )}
            <button
      ...
      <a
        href={`https://wa.me/${rawWA}?text=${WHATSAPP_MSG}`}
        target="_blank"
